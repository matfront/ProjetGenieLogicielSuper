...
public class ArticleUs implements java.io.Serializable {
	private String code;
	...
	*/
	public ArticleUs(String code, String description, double longeur, double largeur, double hauteur, double prix, double qte, double fraisDouane, String provenance) {
